<script lang="ts">
    ...
    function like(id){
        // TODO: send like
        comments[comments.findIndex(comment=>comment.id===id)].votes.push({
        ...
        comments[comments.findIndex(comment=>comment.id===id)]=comments[comments.findIndex(comment=>comment.id===id)]
    }
    function dislike(id){
        // TODO: send dislike
        comments[comments.findIndex(comment=>comment.id===id)].votes.push({
